 ...
 * @Auther: yanghao
 * @Date: 2020/8/5 17:16
 * @PackageName:com.ctgu.fmall.common.security
 * @Description: TODO
 * @Version:V1.0
 */
@Component
@Slf4j
public class MyAdminAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
    @Autowired
    ...
    public void onAuthenticationSuccess(HttpServletRequest req, HttpServletResponse resp, Authentication authentication) throws IOException {
            ...
            Result ok = ResultUtil.success("登录成功", admin);
